    ...
    public class CountAvailableMoves
    {
        ...
        public void Setup()
        {
            TileBaseType[,] tileLayout = new TileBaseType[,]
            {
                ...
                { TileBaseType.Yellow,  TileBaseType.White,     TileBaseType.Magenta,   TileBaseType.White,     TileBaseType.Red,       TileBaseType.Orange,    TileBaseType.Gray,      TileBaseType.Red,       TileBaseType.Green,     TileBaseType.Orange,    TileBaseType.Magenta,   TileBaseType.Green,     TileBaseType.Orange,    TileBaseType.Black,   },
